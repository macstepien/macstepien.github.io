...
excerpt: |
 ...
 <img width="200" height="200" src="/pics/Hexapod/hexi.jpg"> 
---
...
{% include googleDrivePlayer.html id="1noQKXlQ1vrXButIVJD5pkWKFF4-6Anj4/preview" %}
...
{% include googleDrivePlayer.html id="1-2V-3Jp_7RpoSwEOZEm2NZDnmNW3E-5M/preview" %}
...
{% include button.html text="Stereowizja" icon="github" link="https://github.com/TheDarkPhoenix/HexapodStereovision" color="#0366d6" %}
