...
{% include button.html text="Github" icon="github" link="https://github.com/TheDarkPhoenix/Snake" color="#0366d6" %}
...
{% include button.html text="Github" icon="github" link="https://github.com/TheDarkPhoenix/Pong" color="#0366d6" %}
